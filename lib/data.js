...
export const creditBenefits = [
  ...
  },
  {
    ...
    answer:
      "We accept major credit cards and digital payment options for seamless transactions.",
  },
  {
    question: "Can I get a refund on unused credits?",
    answer:
      "Unfortunately, credits are non-refundable, but they never expire and can be used anytime.",
  },
  {
    question: "Is there a free trial available?",
    answer:
      "Yes! Our Basic plan includes 2 free credits, allowing you to experience consultations at no cost.",
  },
  {
    question: "How do I upgrade my subscription?",
    answer:
      "You can upgrade anytime by selecting a higher-tier package in your account settings.",
  },
  {
    question: "Are there any hidden fees?",
    answer:
      "No hidden fees—what you see is what you pay, ensuring complete transparency in pricing.",
  },
  {
    question: "Can I share credits with family members?",
    answer:
      "Credits are linked to your account but can be used to book consultations for family members.",
  },
];
