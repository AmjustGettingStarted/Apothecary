...
export const testimonials = [
  ...
  },
  {
    ...
    name: "D Luffy",
    role: "Patient",
    src: "https://images.pexels.com/photos/16075343/pexels-photo-16075343/free-photo-of-handmade-dolls-and-football-world-cup-trophy.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    quote:
      "Having a subscription means I can always reach my doctor when needed. No worrying about extra charges or appointment delays!",
  },
  {
    initials: "V",
    name: "Dr. Vikram",
    role: "Cardiologist",
    src: "https://images.pexels.com/photos/5722157/pexels-photo-5722157.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    quote:
      "The credit system ensures that patients get timely consultations without administrative delays. It truly enhances accessibility to healthcare.",
  },
  {
    initials: "S",
    name: "Sara",
    ...
    quote:
      "I used to delay doctor visits due to costs, but now I can consult specialists whenever needed. It’s a relief!",
  },
  {
    initials: "A",
    name: "Dr. Aditi",
    role: "General Physician",
    src: "https://plus.unsplash.com/premium_photo-1664475450083-5c9eef17a191?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    quote:
      "With the credit system, I see patients who might have otherwise postponed their visit due to financial concerns. It’s a step toward better healthcare for all.",
  },
  {
    initials: "T",
    name: "Tariq",
    ...
    quote:
      "Having credits ready means I can focus on my health instead of stressing over payments. It’s a game-changer!",
  },
  {
    initials: "K",
    name: "Dr. Keerthana",
    role: "Pediatrician",
    src: "https://plus.unsplash.com/premium_photo-1682089874677-3eee554feb19?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    quote:
      "Parents no longer have to worry about unexpected consultation costs. The credit system makes preventive care more accessible.",
  },
  {
    initials: "M",
    name: "Maya",
    role: "Patient",
    src: "https://images.pexels.com/photos/7580933/pexels-photo-7580933.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    quote:
      "Being able to book consultations on my own terms has made managing my chronic condition much easier and less stressful.",
  },
  {
    initials: "E",
    name: "Dr. Ethan",
    ...
    quote:
      "I appreciate how this system removes barriers to specialist care, allowing patients to seek help exactly when they need it.",
  },
  {
    initials: "R",
    name: "Rohan",
    role: "Patient",
    src: "https://images.pexels.com/photos/1328764/pexels-photo-1328764.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    quote:
      "The subscription model ensures I never have to worry about extra medical expenses, making healthcare stress-free.",
  },
];
...
=======
      "<p>Each consultation requires <strong class='text-emerald-400'>2 credits</strong> regardless of duration</p>",
>>>>>>> 696b9a208663ea7ec7831f6ff1387ae62305d0a7
  },
  {
